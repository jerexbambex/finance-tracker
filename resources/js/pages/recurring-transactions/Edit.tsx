...
export default function Edit({ recurringTransaction, accounts, categories }: Props) {
  const { data, setData, put, processing, errors } = useForm({
    ...
    // Dates come back as full ISO timestamps from the date cast; the date
    // input only accepts the yyyy-MM-dd portion.
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <Breadcrumb className="mb-4">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Edit Recurring Transaction</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>

          <h1 className="text-2xl sm:text-3xl font-bold mb-6">Edit Recurring Transaction</h1>
