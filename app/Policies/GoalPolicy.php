...
class GoalPolicy
{
    ...
    {
        return $authUser->id === $goal->user_id || $authUser->can('View:Goal');
    }
    ...
    {
        return $authUser->id === $goal->user_id || $authUser->can('Update:Goal');
    }

    public function delete(AuthUser $authUser, Goal $goal): bool
    {
        return $authUser->id === $goal->user_id || $authUser->can('Delete:Goal');
    }

    public function deleteAny(AuthUser $authUser): bool
    {
        return $authUser->can('DeleteAny:Goal');
    }
