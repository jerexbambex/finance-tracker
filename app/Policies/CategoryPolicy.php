...
class CategoryPolicy
{
    ...
    {
        return $authUser->id === $category->user_id || $authUser->can('View:Category');
    }
    ...
    {
        return $authUser->id === $category->user_id || $authUser->can('Update:Category');
    }

    public function delete(AuthUser $authUser, Category $category): bool
    {
        return $authUser->id === $category->user_id || $authUser->can('Delete:Category');
    }
