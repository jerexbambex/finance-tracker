...
/**
 * Global (not per-user) exchange rates. The daily exchangerates:update
 * schedule keeps these fresh; this resource is the manual fallback for a
 * currency the provider doesn't cover, or for overriding a bad rate.
 */
